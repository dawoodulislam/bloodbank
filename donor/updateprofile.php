...
<div style="height:500px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 <form method="post">
    ...
    <tr><td style="padding-bottom:40px" colspan="2" align="center"><h1 style="font-size:50px; color: darkred;">Profile Update</h1></td></tr><br>
...
<tr><td class="lefttd">Gender</td><td><input name="r1" type="radio" value="male"  <?php if($gender=="male"){ echo "checked" ;}  ?>>Male<input name="r1" checked="checked" type="radio" value="female" <?php if($gender=="female"){ echo "checked" ;}  ?> />Female</td></tr>
       ...
       <tr><td class="lefttd"  style="vertical-align:middle"> Address</td><td><input type="textarea" name="t4" value="<?php echo @$add;?>"  /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
       <tr><td class="lefttd"  style="vertical-align:middle"> Blood Group</td><td><input type="textarea" name="t5" value="<?php echo @$blg;?>"  /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
<?php
	...
	if(isset($_POST["sbmt"])) 
	{
		$cn=makeconnection();
					...
					$s="update donarregistration set name='" .$_POST["t1"]. "' ,gender='" .$_POST["r1"]."' , age='" .$_POST["t2"]. "',mobile='" .$_POST["t3"]. "',Address='" .$_POST["t4"]. "',bg_name='" .$_POST["t5"]. "' where email='" .$_SESSION["email"]. "'";
