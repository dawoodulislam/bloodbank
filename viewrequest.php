...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
 ...
 <table cellpadding="20" cellspacing="20" width="1000px" height="200px"  style="margin:auto" >
   ...
   <tr><td colspan="7" align="center"><h1 style="font-size:50px; color: darkred;">View Blood Request</h1></td></tr>
 ...
 <tr style="background-color:bisque" align="center" class="bold">            
            ...
            <td align="center">Till Required Date</td><td align="center">Responce</td>
        </tr>
...
$s="select * from requestes";
	...
	{
				echo"<tr><td  style=' padding-left:50px'>$data[0]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td><td  style=' padding-left:30px'>$data[3]</td><td  style=' padding-left:50px'>$data[4]</td><td  style=' padding-left:50px'>$data[5]</td><td  style=' padding-left:60px'>$data[6]</td><td  style=' padding-left:60px'><button name='donner' value='21'>OK</button></td></tr>";
			}
			mysqli_close($cn);
			?>
	</form>
